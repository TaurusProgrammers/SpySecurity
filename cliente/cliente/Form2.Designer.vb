...
Partial Class Form2
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "#reiniciar  -  Reiniciar pc victima"
        '
        'Label2
        '
        ...
        Me.Label2.Text = "#apagar   -  Apagar pc victima"
        '
        'Label3
        '
        ...
        Me.Label3.Text = "#nullshut   -  Cancelar Shutdwon pc victima"
        '
        'Label4
        '
        ...
        Me.Label4.Text = "#SesionOff   -  Cerrar session pc victima"
        '
        'Label5
        '
        ...
        Me.Label5.Text = "#msgErr   -  Enviar Errores a PC victima"
        '
        'Label6
        '
        ...
        Me.Label6.Size = New System.Drawing.Size(460, 15)
        Me.Label6.TabIndex = 5
        Me.Label6.Text = "#ipmaster   -  Asigna la ip al cual resiviras imagen WEBCAM(#ipmaster 192.168.1.2" & _
            "0)"
        '
        'Label7
        '
        ...
        Me.Label7.Text = "#webview  -  activar recepcion de webcam"
        '
        'Form2
        '
